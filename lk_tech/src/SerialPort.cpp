...
//! @link           https://github.com/gbmhunter/CppLinuxSerial.git
//! @created        2014-01-07
...
namespace CppLinuxSerial {
    ...
    void SerialPort::ReadBinary(std::vector<uint8_t>& data) {
        ...
        if(n < 0) {
            ...
            // Sina
            std::copy(readBuffer_.begin(), readBuffer_.begin() + n, data.begin());
            // data.assign(readBuffer_.begin(), readBuffer_.begin() + n);
        }
